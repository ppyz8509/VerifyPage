...
WebUI.setText(findTestObject('input_birthday'), '13/07/2543')
...
result_branch_default = WebUI.getAttribute(findTestObject('input_branch'), 'placeholder')
...
WebUI.click(findTestObject('checkbox_c1'))


WebUI.verifyElementClickable(findTestObject('input_invoice'))

result_branch_default = WebUI.getAttribute(findTestObject('input_branch2'), 'placeholder')
